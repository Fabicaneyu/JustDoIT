...
//    }
//
//    @GetMapping("/recomendados/final")
//    public ResponseEntity recomendados() {
//        try {
//            List<Conhecimento> result = controller.re();
//            if (result == null) {
//                return ResponseEntity.status(HttpStatus.NO_CONTENT)
//                        .body("Nenhum conhecimento na base de dados");
//            }
...
//                            .nivel(level).build();
//
//                    List conhecimentos = userController.buscarPorLevelandConhecimento(consulta);
//
//                    if (conhecimentos == null) {
//                        return new ResponseEntity("Infelizmente ainda não temos usuários que" +
//                                "possuem este nível de conhecimento .",HttpStatus.NOT_FOUND);
...
//
//                    List conhecimentos = userController.buscarPorLevel(consulta.getNivel());
//
//                    if (conhecimentos == null) {
...
//
//            List conhecimentos = userController.buscarConhecimentos(consulta.getConhecimento());
//
//
//            if (conhecimentos == null) {
