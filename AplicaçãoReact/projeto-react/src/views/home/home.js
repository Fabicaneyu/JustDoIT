...
class Home extends React.Component {
  ...
  initial = () => {
    axios
      .get("https://springbootappjdit.azurewebsites.net/post/load/initial")
      .then((response) => {
        this.loadPage();
      })
      .catch((erro) => {
  ...
  loadRecomendation = () => {
    axios
      .get("https://springbootappjdit.azurewebsites.net/conhecimentos/recomendados")
      .then((response) => {
  ...
  loadPage = () => {
    axios
      .get("https://springbootappjdit.azurewebsites.net/post/load/feed")
      .then((response) => {
        const dados = response.data;
        if (!dados[0].id) {
  ...
  interact = (id, type, count) => {
    ...
    if (
      ...
      if (achou > 0) {
        ...
        axios
          .post(`https://springbootappjdit.azurewebsites.net/reacoes/reagir`, {
  ...
  sair = () => {
    axios
      .get("https://springbootappjdit.azurewebsites.net/user/logoff")
      .then((response) => {
  ...
  postar = () => {
    axios
      .post("https://springbootappjdit.azurewebsites.net/post/new", {
